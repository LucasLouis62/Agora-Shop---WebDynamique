...
<div class="container my-4 p-4 border rounded shadow bg-white">
    ...
    <main class="text-center mb-4">
        ...
        <div class="row justify-content-center">
            <div class="d-flex gap-2 mb-3 text-start">
                <!-- Tri -->
                <div class="dropdown">
                    <button class="btn btn-primary dropdown-toggle" type="button" data-bs-toggle="dropdown">Trier</button>
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="?tri=prix_croissant&valeur=<?= htmlspecialchars($valeur) ?>&prix_min=<?= $prix_min ?>&prix_max=<?= $prix_max ?>">Prix croissant</a></li>
                        <li><a class="dropdown-item" href="?tri=prix_decroissant&valeur=<?= htmlspecialchars($valeur) ?>&prix_min=<?= $prix_min ?>&prix_max=<?= $prix_max ?>">Prix décroissant</a></li>
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="?prix_min=1&prix_max=10000&valeur=<?= $valeur ?>&tri=<?= $tri ?>">0 - 10 000 €</a></li>
                        <li><a class="dropdown-item" href="?prix_min=10001&prix_max=30000&valeur=<?= $valeur ?>&tri=<?= $tri ?>">10 001 - 30 000 €</a></li>
                        <li><a class="dropdown-item" href="?prix_min=30001&prix_max=50000&valeur=<?= $valeur ?>&tri=<?= $tri ?>">30 001 - 50 000 €</a></li>
                        <li><a class="dropdown-item" href="?prix_min=50001&prix_max=100000&valeur=<?= $valeur ?>&tri=<?= $tri ?>">50 001 - 100 000 €</a></li>
                    </ul>
                </div>
            </div>
                    ...
                    <div class="card h-100 shadow-sm">
                        ...
                        <div class="card-body text-center">
                            ...
                            <?php elseif ($annonce['type_vente'] === 'negociation'): ?>
                                <div class="d-grid gap-2 mt-2">
                                    <a href="annonce.php?id=<?= $annonce['id'] ?>#acheter" class="btn btn-primary">Faire une offre</a>
                                    <form method="POST" action="ajouter_au_panier.php">
                                        <input type="hidden" name="produit_id" value="<?= $annonce['id'] ?>">
                                        <button type="submit" class="btn btn-outline-success">Ajouter au panier</button>
                                    </form>
    ...
    <footer class="mt-4">
        <div class="row text-center text-md-start align-items-center">
            ...
            <div class="col-md-4">
                <h5>Nous trouver</h5>
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2624.8878757609433!2d2.2847854156752096!3d48.850725779286154!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47e6701b486bb253%3A0x61e9cc6979f93fae!2s10%20Rue%20Sextius%20Michel%2C%2075015%20Paris!5e0!3m2!1sfr!2sfr!4v1685534176532!5m2!1sfr!2sfr" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade" width="220" height="120" style="border-radius:8px;" allowfullscreen="" loading="lazy"></iframe>
            </div>
        </div>
    </footer>
</div>
