    ...
    <div class="container my-4 p-4 border rounded shadow" style="background:#fff;">
        ...
        <footer class="mt-4">
            <div class="row text-center text-md-start align-items-center">
                ...
                <div class="col-md-4">
                    <h5>Nous trouver</h5>
                    <iframe src="https://www.google.com/maps/embed?..." width="220" height="120" style="border:0; border-radius:8px;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                </div>
            </div>
        </footer>
    </div>
