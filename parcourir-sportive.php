...
if ($db_found) {
    ...
    // Requête SQL pour récupérer les sportives avec le tri, le filtre et la plage de prix
                ...
                <div class="d-flex gap-2 mb-3 text-start">
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButtonPrice">
                            <li><a class="dropdown-item" href="?prix_min=100000&prix_max=250000&valeur=<?php echo htmlspecialchars($valeur); ?>&tri=<?php echo htmlspecialchars($tri); ?>">100 000 - 250 000 €</a></li>
                            <li><a class="dropdown-item" href="?prix_min=250001&prix_max=500000&valeur=<?php echo htmlspecialchars($valeur); ?>&tri=<?php echo htmlspecialchars($tri); ?>">250 001 - 500 000 €</a></li>
                            <li><a class="dropdown-item" href="?prix_min=500001&prix_max=1000000&valeur=<?php echo htmlspecialchars($valeur); ?>&tri=<?php echo htmlspecialchars($tri); ?>">500 001 - 1 000 000 €</a></li>
                            <li><a class="dropdown-item" href="?prix_min=1000001&prix_max=2000000&valeur=<?php echo htmlspecialchars($valeur); ?>&tri=<?php echo htmlspecialchars($tri); ?>">1 000 001 - 2 000 000 €</a></li>
                        </ul>
                    </div>
                </div>
